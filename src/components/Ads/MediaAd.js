            ...
            <div className="w-full">
                <div className="flex flex-col sm:flex-row sm:space-x-3 ">
                    <div className="flex-grow">
                        <h2 className="text-lg font-semibold mb-2">Landscape Marketing image(1,9:1)</h2>
                        <input type="text" className="border border-gray-300 rounded p-2 w-full" placeholder="Enter business name" />
                    </div>
                    <div className="flex-grow">
                        <h2 className="text-lg font-semibold mb-2">Portrait Marketing Image(4:5)</h2>
                        <input type="text" className="border border-gray-300 rounded p-2 w-full" placeholder="Enter business name" />
                    </div>
                    <div className="flex-grow">
                        <h2 className="text-lg font-semibold mb-2">Square Marketing Image(1:1)</h2>
                        <input type="text" className="border border-gray-300 rounded p-2 w-full" placeholder="Enter business name" />
                    </div>
                </div>
            </div>
